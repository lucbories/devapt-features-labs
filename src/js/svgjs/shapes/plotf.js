...
// PLUGIN IMPORTS
import Position from '../../geometry/geopoint'
import Drawable from '../drawable'


const plugin_name = 'Labs' 
const context = plugin_name + '/svgjs/shapes/plotf'
...
export default class PlotF extends Drawable
{
	...
	_draw_self()
	{
		...
		const height_pixel = this.svg_space().pixelbox().get_usable().height
		const width_pixel = this.svg_space().pixelbox().get_usable().width
		const top_left_pixel = this.svg_space().pixelbox().get_usable().top_left
